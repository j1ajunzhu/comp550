...
model.save_pretrained(f"{script_args.output_name}", safe_serialization=False)
tokenizer.save_pretrained(f"{script_args.output_name}")

#use python merge.py --adapter_model_name /workspace/comp550/ft/llama2-hf-try --base_model_name /workspace/Llama-2-7b-hf --output_name try_merge